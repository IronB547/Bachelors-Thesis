...
public class CameraManager : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (elapsedTime < 1)
		{
			...
			if (switchCam == 1)
				// Switch to stock third person view.
		...
		if (printRay)
		{
			...
			Debug.DrawRay(mainCam.transform.position - new Vector3(0, 0.5f, -0.5f), mainCam.transform.position - targetObject.transform.position + new Vector3(0f, -10f, 0f), Color.magenta);
